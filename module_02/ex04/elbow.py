...
def prepare_clustering_features(data):
    ...
    customer_features.columns = ['user_id', 'total_spent', 'order_count', 'avg_order_value']
...
def main():
    ...
    try:
        ...
        cluster_range, inertias = calculate_elbow_method(features_scaled, max_clusters=10)
        ...
        print("- Look for the 'bend' in the curve where the slope changes significantly")
